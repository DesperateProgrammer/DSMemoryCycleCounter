...
void RunVRAMTests()
{
  ...
  {
    R08_133 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_8) * GetCPUClockMultiplier() / 4;
    iprintf(" 8b   Reads: %i\n", R08_133);
    R16_133 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_16) * GetCPUClockMultiplier() / 4;
    iprintf("16b   Reads: %i\n", R16_133);
    R16x2_133 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_16x2) * GetCPUClockMultiplier() / 4;
    iprintf("16bx2 Reads: %i\n", R16x2_133);
    R32_133 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_32) * GetCPUClockMultiplier() / 4;
    iprintf("32b   Reads: %i\n", R32_133);
    R32x2_133 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_64) * GetCPUClockMultiplier() / 4;
  ...
  {
    R08_66 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_8) * GetCPUClockMultiplier() / 4;
    iprintf(" 8b   Reads: %i\n", R08_66);
    R16_66 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_16) * GetCPUClockMultiplier() / 4;
    iprintf("16b   Reads: %i\n", R16_66);
    R16x2_66 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_16x2) * GetCPUClockMultiplier() / 4;
    iprintf("16bx2 Reads: %i\n", R16x2_66);
    R32_66 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_32) * GetCPUClockMultiplier() / 4;
    iprintf("32b   Reads: %i\n", R32_66);
    R32x2_66 = MeasureDataAccess(0x06860000, DATAACCESS_READ | DATAACCESS_64) * GetCPUClockMultiplier() / 4;
    iprintf("32bx2 Reads: %i\n", R32x2_66);
  } else
  {
